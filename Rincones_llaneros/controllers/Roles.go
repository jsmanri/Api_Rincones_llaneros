...
func (c *RolesController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddRoles(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"success": true, "status": 201, "Message": "creado correctamente", "rol creado": v}
		} else {
...
func (c *RolesController) GetOne() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "consulta correctamente", "rol consultado": v}
	}
	c.ServeJSON()
}
...
func (c *RolesController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "consulta correctamente", "roles consultados": l}
	}
	c.ServeJSON()
}
...
func (c *RolesController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateRolesById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Actualizacion correctamente", "rol actualizado": v}
		} else {
			c.Data["json"] = err.Error()
		}
	} else {
...
func (c *RolesController) Delete() {
	...
	if err := models.DeleteRoles(id); err == nil {
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Eliminacion correctamente", "rol eliminado": id}
	} else {
		c.Data["json"] = err.Error()
	}
	c.ServeJSON()
