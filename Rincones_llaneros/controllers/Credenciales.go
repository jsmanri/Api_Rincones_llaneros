...
// @Success 201 {int} models.Credenciales
...
func (c *CredencialesController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCredenciales(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"success": true, "status": 201, "Message": "Creado correctamente", "credencial creada": v}
		} else {
...
func (c *CredencialesController) GetOne() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "consulta correctamente", "credencial consultado": v}
	}
	c.ServeJSON()
}
...
func (c *CredencialesController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "consulta correctamente", "credenciales consultadas": l}
	}
	c.ServeJSON()
}
...
func (c *CredencialesController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCredencialesById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Actualizacion correctamente", "credencial actualizada": v}
		} else {
			c.Data["json"] = err.Error()
		}
	} else {
...
func (c *CredencialesController) Delete() {
	...
	if err := models.DeleteCredenciales(id); err == nil {
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Eliminacion correctamente", "credncial eliminada": id}
	} else {
		c.Data["json"] = err.Error()
	}
	c.ServeJSON()
