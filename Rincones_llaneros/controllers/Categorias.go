...
func (c *CategoriasController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCategorias(&v); err == nil {
			...
			c.Data["json"] = map[string]interface{}{"success": true, "status": 201, "Message": "creado correctamente", "se a creado un nueva categoria": v}
		} else {
...
func (c *CategoriasController) GetOne() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "consultado correctamente", "se consulto la categoria": v}
	}
	c.ServeJSON()
}
...
func (c *CategoriasController) GetAll() {
	...
	if err != nil {
		...
		c.Data["json"] = map[string]interface{}{"success": true, "status": 202, "Message": "consultado correctamente", "categorias consultadas": l}
	}
	c.ServeJSON()
}
...
func (c *CategoriasController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCategoriasById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Actualizado correctamente", "se a actualizado la categoria": v}
		} else {
			c.Data["json"] = err.Error()
		}
	} else {
...
func (c *CategoriasController) Delete() {
	...
	if err := models.DeleteCategorias(id); err == nil {
		c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Eliminado correctamente", "se elimino la categoria": id}
	} else {
		c.Data["json"] = err.Error()
	}
	c.ServeJSON()
